...
**/
(function () {
  'use strict'; // If we have a prehistoric browser, make an early exit.
  ...
  function reflect(attributeName, propertyName) {
    Object.defineProperty(Element.prototype, propertyName, {
      ...
      set: function set(value) {
        if (value !== null) this.setAttribute(attributeName, value);else this.removeAttribute(attributeName);
      }
    });
  } // AccessibilityRole


  if (!Element.prototype.hasOwnProperty('role')) reflect('role', 'role'); // AriaAttributes

  if (!Element.prototype.hasOwnProperty('ariaLabel')) ['ActiveDescendant', 'Atomic', 'AutoComplete', 'Busy', 'Checked', 'ColCount', 'ColIndex', 'ColSpan', 'Controls', 'Current', 'DescribedBy', 'Details', 'Disabled', 'ErrorMessage', 'Expanded', 'FlowTo', 'HasPopup', 'Hidden', 'Invalid', 'KeyShortcuts', 'Label', 'LabelledBy', 'Level', 'Live', 'Modal', 'MultiLine', 'MultiSelectable', 'Orientation', 'Owns', 'Placeholder', 'PosInSet', 'Pressed', 'ReadOnly', 'Relevant', 'Required', 'RoleDescription', 'RowCount', 'RowIndex', 'RowSpan', 'Selected', 'SetSize', 'Sort', 'ValueMax', 'ValueMin', 'ValueNow', 'ValueText'].forEach(function (name) {
